/* ═══════════════════════════════════════════════════════════════
   ...
   Vanilla JS: product catalogue, multi-currency, cart, filters,
...
(function () {
  ...
  function setCurrency(code) {
    currency = code;
    $$('.currency-btn').forEach(b => b.setAttribute('aria-pressed', String(b.dataset.currency === code)));
    renderProducts();
    renderCart();
  }
  ...
  function bindEvents() {
    // currency
    $$('.currency-btn').forEach(b => b.addEventListener('click', () => setCurrency(b.dataset.currency)));
